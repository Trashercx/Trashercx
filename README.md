<!-- HEADER: ESTRUCTURA EJECUTIVA A DOS COLUMNAS CON TU GIF -->
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="65%" valign="middle" align="left">
      <h1 style="color: #A970FF; margin-bottom: 0px; font-size: 32px;">Oscar Ivan</h1>
      <h3 style="color: #00B4DB; margin-top: 5px; font-size: 18px;">Ingeniero de Sistemas | Backend Developer & Cloud Architect</h3>
      <p style="font-size: 15px; line-height: 1.5; color: #9CB6D9;">
    ...
    <td width="35%" align="center" valign="middle">
      <!-- TU GIF LOCAL INTEGRADO -->
      <img src="gif1.gif" width="95%" style="border-radius: 12px; border: 1px solid #1E293B; box-shadow: 0 8px 24px rgba(0,0,0,0.6);" alt="Tech Animation" />
    </td>
  </tr>
</table>
...
<table width="100%" style="border-collapse: collapse; border: none;">
  <tr>
    ...
    <td align="left" width="50%" style="padding: 20px; border: 1px solid #1E293B; background: rgba(13, 17, 23, 0.6); border-radius: 8px;">
      ...
      <a href="https://github.com/Trashercx" target="_blank">
        <img src="https://img.shields.io/badge/Ver_Documentación-→-A970FF?style=for-the-badge&logoColor=white" alt="View Project"/>
      </a>
    </td>
  </tr>
</table>
...
<div align="center">
  <picture>
    ...
    <img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/Trashercx/Trashercx/output/github-contribution-grid-snake.svg">
  </picture>
</div>
...
<div align="center">
  <p style="color: #00B4DB; font-size: 14px;"><i>"La infraestructura invisible es la que sostiene la innovación visible."</i></p>
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:A970FF,100:002D62&height=100&section=footer" width="100%" />
</div>
